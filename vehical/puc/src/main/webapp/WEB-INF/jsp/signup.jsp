...
<body>
    ...
    <%@ include file="headerpuc.jsp"%>
<div class="container">
    <div class="row">
        <div class="col">
            <r>Register yourself and your vehicle(s)</r>
        <br>
        ...
        <div class="col">
            <form action="registerform" method="post">
                ...
                <div class="input-field">
                    ...
                    <input type="text" name="c" placeholder="Mobile Number" />
                </div>
                <div class="input-field">
                    <i class="fas fa-building"></i>
                    <input type="text" name="d" placeholder="Address" />
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    ...
                    <input type="password" name="f" placeholder="Password" />
                </div>
                <div class="input-field">
                    <i class="fas fa-id-card"></i>
                    <input type="text" name="g" placeholder="License Number" />
                </div>
